...
from authentication.utils import check_username_exists
...
class RegisterForm(forms.Form):
    ...
    def save(self):
        ...
        user = UserAccount.objects.create_user(username, email, password, first_name=firstname, last_name=lastname)
        user.save()
        return user
